...
- Conjuntos em qualquer Linguagem de programação, estamos fazendo referência á Teoria dos Conujuntos
de Matemática.
...
# será ignorado sem gerar error e não faz parte do conjunto.
...
# Importante lembrar que, além de não temos valores duplicados, não temos ordem

# Listas aceitam valores duplicados, então tem 10 elementos
'''
lista = [99, 2, 34, 23, 2, 12, 1, 44, 5, 34]
print(f'Lista: {lista} com {len(lista)} elementos')
'''

# Tuplas aceitam valores duplicados, então tem 10 elementos
'''
tupla = (99, 2, 34, 23, 2, 12, 1, 44, 5, 34)
print(f'Tupla: {tupla } com {len(tupla)} elementos')
'''

# Dicionários não aceitam valores duplicados, então tem 8 elementos
'''
dicionario = {}.fromkeys([99, 2, 34, 23, 2, 12, 1, 44, 5, 34], 'dict')
print(f' Dicionário: {dicionario} com {len(dicionario)} elementos')
'''

# Conjunto não aceitam valores duplicados, então tem 10 elementos
'''
...
print(type(cidades))
'''
# Agora precisamos saber quantas distintas, ou seja, únicas, temos.
...
# Forma 1
'''
s.remove(3) # NÃO é ìndice! Informamos o valor a ser removido.
print(s)
'''
