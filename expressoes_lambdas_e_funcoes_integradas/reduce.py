...
A função reduce(), funciona da seguinte forma:
    Passo 1: res1 = f(ai, a2) # Aplica a função nos dois primeiros elementos da coleção e guarda o resutado.
...
Ou seja, em cada passo ela aplica a função passando como primeiro argumento o resultado da aplicação anteriror. No final,
reduce() irá retornar o resultado final.

Alternativamente, poderiamos ver a função reduce() como:

função(função(a1, a2), a3), ...), an)
"""
