...
# Len
"""
len() -> Retorna o tamanho (ou seja, o número de itens) de um interável
"""
# Só pra revisar
"""
...
# Round
"""
round() -> Retorna um número arrendondado para n digito de precisão após a casa decimal. Se a precisão não for
