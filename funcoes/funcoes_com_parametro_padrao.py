...
# OBS:
# Se o usuário passar somente 1 argumento, este será atribuido ao parâmetro numero, e será calculado o quadrado deste número;
...
# OBS: Emfunções Python, os parâmetros com valores default (padrão) DEVEM sempre estar ao final da declaração.
# ERRO
'''
def teste(potencia=2, num):
    return num ** potencia
