...
Este é só mais um parâmetro, mas diferentes do *args que coloca os valores e extras
...
cores_favoritas(marcos='verde', julio='amarelo', fernanda='azul', vanessas='branco')

# OBS: Os parâmetros *args não são obrigatórios.
...
print(cumprimento_especial(geek='Ppython'))
print(cumprimento_especial(geek='Oi'))
print(cumprimento_especial(geek='especial'))
'''

# Nas nosssas funções, podemos ter (NESTA ORDEM):
'''
